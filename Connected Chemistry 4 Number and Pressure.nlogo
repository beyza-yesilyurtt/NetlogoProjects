...
to collide-with [ other-particle ] ;; particle procedure
  ...
  set heading2 [headıng] of other-particle
  ...
  set v1t (speed * cos (theta - headıng))
  set v1l (speed * sin (theta - headıng))
  ...
  if v1l != 0 or v1t != 0
    [ set headıng (theta - (atan v1l v1t)) ]

  ;; and do the same for other-particle
  ask other-particle [
    set speed sqrt ((v2t ^ 2) + (v2l ^ 2))
    if v2l != 0 or v2t != 0
      [ set headıng (theta - (atan v2l v2t)) ]
  ]
